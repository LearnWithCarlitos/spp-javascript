...
export function remainingMinutesInOven(actualMinutesInOven) {
    var res = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
    return res;
}
...
export function preparationTimeInMinutes(numberOfLayers) {
    let res = numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
    return res;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
    let res = numberOfLayers * 2 + actualMinutesInOven;
    return res;
}
...
/*
    ...
    - SOURCE & BIBLIOGRAPHY:
        ...
        - https://github.com/exercism/javascript/tree/main/exercises/concept/lasagna
